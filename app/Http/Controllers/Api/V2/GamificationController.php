...
class GamificationController
{
    ...
    public function achievements(): JsonResponse
    {
        try {
            ...
            return response()->json(['success' => true, 'message' => 'Achievements retrieved', 'data' => $data]);
        } catch (\Exception $e) {
    ...
    public function challenges(): JsonResponse
    {
        try {
            ...
            return response()->json(['success' => true, 'message' => 'Challenges retrieved', 'data' => $data]);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
    ...
    public function rewards(): JsonResponse
    {
        try {
            ...
            return response()->json(['success' => true, 'message' => 'Rewards retrieved', 'data' => $data]);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
    ...
    public function grantAchievement(Request $request, int $achievement_id): JsonResponse
    {
        try {
            $user = $request->user();
            if (!$user) {
            ...
            $result = $this->service->grantAchievement($user, $achievement_id, $payload['additional_info']);
    ...
    public function completeChallenge(Request $request, int $challenge_id): JsonResponse
    {
        try {
            $user = $request->user();
            if (!$user) {
            ...
            $result = $this->service->completeChallenge($user, $challenge_id, $payload['additional_info']);
    ...
    public function redeemReward(Request $request, int $reward_id): JsonResponse
    {
        try {
            ...
            $result = $this->service->redeemReward($user, $reward_id, $payload['additional_info']);
            ...
            if (str_contains($errorMessage, 'Koin tidak mencukupi') || str_contains($errorMessage, 'not enough coins')) {
                return response()->json([
                    'success' => false,
            ...
            if (str_contains($errorMessage, 'Stok hadiah habis') || str_contains($errorMessage, 'stock')) {
                return response()->json([
                    'success' => false,
    ...
    public function coinTransactions(Request $request): JsonResponse
    {
        try {
            ...
            $filters = [];
            if ($request->query('per_page')) $filters['per_page'] = (int) $request->query('per_page');
            if ($request->query('page')) $filters['page'] = (int) $request->query('page');
            
            $data = $this->service->getCoinTransactions((int) $userId, $filters);
            return response()->json([
                'success' => true, 
