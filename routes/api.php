...
Route::middleware('api')->prefix('v2')->group(function () {
    ...
    Route::middleware('private')->group(function () {
        ...
        Route::prefix('articles')->group(function () {
            ...
            Route::get('/id/{article_id}', [ArticlesController::class, 'show']);
        });
        ...
        Route::prefix('gamification')->group(function () {
            ...
            Route::get('/coins/transactions', [GamificationController::class, 'coinTransactions']);
            Route::get('/exp/transactions', [GamificationController::class, 'expTransactions']);
            ...
            Route::post('/rewards/{reward_id}/redeem', [GamificationController::class, 'redeemReward']);
        });

        // Social
        Route::prefix('social')->group(function () {
            Route::get('/posts', [SocialController::class, 'posts']);
            Route::get('/posts/id/{post_id}', [SocialController::class, 'postDetail']);
            Route::post('/posts', [SocialController::class, 'createPost']);

            Route::get('/follow', [SocialController::class, 'followData']);
            Route::post('/follow/id/{user_id}', [SocialController::class, 'follow']);

            Route::get('/posts/id/{post_id}/likes', [SocialController::class, 'likes']);
            Route::post('/posts/id/{post_id}/like', [SocialController::class, 'likePost']);

            Route::get('/posts/id/{post_id}/comments', [SocialController::class, 'comments']);
            Route::post('/posts/id/{post_id}/comment', [SocialController::class, 'commentPost']);

            Route::get('/comments/id/{comment_id}/likes', [SocialController::class, 'commentLikes']);
            Route::post('/comments/id/{comment_id}/like', [SocialController::class, 'likeComment']);
        });
        ...
        Route::prefix('leaderboard')->group(function () {
            ...
            Route::get('/id/{leaderboard_id}', [LeaderboardController::class, 'getLeaderboardById']);
